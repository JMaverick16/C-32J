...
var thunder_listener = func {
    ...
    settimer(func {
        var thunder1 = getprop("b757/sound/thunder1");
        var thunder2 = getprop("b757/sound/thunder2");
        var thunder3 = getprop("b757/sound/thunder3");
        var thunder4 = getprop("b757/sound/thunder4");
        var thunder5 = getprop("b757/sound/thunder5");
        var vol = 0;
        ...
        if (!thunder1) {
            thunderCalls = 1;
            setprop("b757/sound/dist-thunder1", lightning_distance_norm * vol * 2.25);
        }
        else if (!thunder2) {
            thunderCalls = 2;
            setprop("b757/sound/dist-thunder2", lightning_distance_norm * vol * 2.25);
        }
        else if (!thunder3) {
            thunderCalls = 3;
            setprop("b757/sound/dist-thunder3", lightning_distance_norm * vol * 2.25);
        }
        else if (!thunder4) {
            thunderCalls = 4;
            setprop("b757/sound/dist-thunder4", lightning_distance_norm * vol * 2.25);
        }
        else if (!thunder5) {
            thunderCalls = 5;
            setprop("b757/sound/dist-thunder5", lightning_distance_norm * vol * 2.25);
        }
        else
            return;
...
var play_thunder = func (name, timeout=0.1, delay=0) {
    var sound_prop = "/b757/sound/" ~ name;
